...
class ZenProject(BaseModel):
    ...
    organisation_id: str = Field(..., alias="organisationId", description="Organization ID")
...
class ZenFile(BaseModel):
    ...
    type: Optional[FileType] = Field(FileType.file, description="File type (file or folder)")
    ...
    parent_id: Optional[str] = Field(None, alias="parentId", description="Parent file/folder ID")
